 ...
 * */
export declare function useDerivedStateFromProps<T>(prop: T, customizer?: (next: T, prev: T) => boolean): readonly [T, import("react").Dispatch<import("react").SetStateAction<T>>];
